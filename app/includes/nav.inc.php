...
<head>
  ...
  <!-- TITLE OF THE PAGE -->
  <title>SerbiaNews | Vesti | <?php echo $page_title; ?></title>
...
<body>
  ...
  <nav class="navbar">
    ...
    <ul class="ul">
      ...
      <li><a href="./index.php" <?php if($home) echo 'class="current"' ?>>Početna</a></li>
      <li>
        ...
        <ul>
          ...
          ?>
          <li><a href="./categories.php">Još +</a></li>
        </ul>
      </li>
      <li><a href="./bookmarks.php" <?php if($bookmark) echo 'class="current"' ?>>Označene</a></li>
      <?php
      ...
      <li>
        ...
        <ul>
          <li><a href="./user-login.php">Čitalac</a></li>
